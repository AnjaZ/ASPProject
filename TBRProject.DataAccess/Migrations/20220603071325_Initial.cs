    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderActions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadersList", x => new { x.BookId, x.UserId, x.Action });
                    table.ForeignKey(
                        name: "FK_ReadersList_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadersList_ReaderActions_Action",
                        column: x => x.Action,
                        principalTable: "ReaderActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReadersList_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReaderActions_Name",
                table: "ReaderActions",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ReadersList_Action",
                table: "ReadersList",
                column: "Action");

            migrationBuilder.CreateIndex(
                name: "IX_ReadersList_UserId",
                table: "ReadersList",
                column: "UserId");
