...
namespace TBRProject.Api.Core
{
    public class JwtManager
    {
        private readonly TBRContext _context;
        private readonly JwtSettings _settings;

        public JwtManager(TBRContext context, JwtSettings settings)
        {
            _settings = settings;
            _context = context;
        }
        ...
        public string MakeToken(string email, string password)
        {
            ...
            //var useCases = _context.UserUseCases.Where(x => x.UserId == user.UserId.Select(x => x.UseCaseId);
